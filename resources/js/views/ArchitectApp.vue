    ...
    <template v-else>
      ...
      >
          ...
          <div class="w-full bg-blue-900 p-2 h-15 flex sm:w-255">
            ...
            >
              ...
              <div
                ...
                class="absolute bg-red-600 rounded-full w-3 h-3 top-0 right-0"
              />
            </div>
            <router-link
              :to="{name: 'home'}"
            ...
            >
              <img
                src="/vendor/architect/images/architect-logo.png"
                alt=""
                class="h-15"
              >
            </router-link>
        ...
        <div class="flex flex-1">
          <div
            class="hidden navigation w-255 max-w-255 sm:block sm:relative p-2 flex-1 bg-blue-700 shadow"
            style="flex: 0 0 255px"
          >
            <architect-nav class="flex-1" />
          </div>
      ...
      <div
        v-if="showMobileNav"
        class="fixed top-0 left-0 w-full h-full bg-blue-700 overflow-auto"
      >
        <div class="h-full p-4">
          <architect-nav class="pb-15 overflow-y-scroll" />
        </div>

        <div class="w-full fixed bottom-0 leading-tight cursor-pointer">
          <a
            class="no-underline text-center text-7 text-xl p-6 text-center text-gray-100 block"
      ...
      <portal-target name="secondary-modal" />
    </template>
  </div>
</template>
