...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    closeTagSearch: function closeTagSearch() {
      this.searchTerm = '';
      this.searchResults = [];
