...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    submitForm: function submitForm() {
      ...
      this.collectData();
      console.log(this.values); // window.Architect.request().post(url, this.collectData())
      //     .then((response) => {
